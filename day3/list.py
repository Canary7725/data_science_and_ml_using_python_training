...
# print(fruits[1:3])  # Slicing list_name[>=start_index:<end_index]
...
# fruits.append('papaya') #Add by value
# fruits.insert(3, 'papaya') #Add by index
...
# print(len(fruits))  # size of the list
